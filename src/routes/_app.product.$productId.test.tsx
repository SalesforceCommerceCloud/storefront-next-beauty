...
describe('Product Detail Route', () => {
    ...
    describe('shouldRevalidate export', () => {
        ...
        // src/lib/revalidation/routes/product.test.ts. The cosmetic route re-exports that exact
        // shared function (same as canonical), so we only assert the wiring here — the behavior
